<template>
  <div class="container w-full">
    <div class="flex flex-col md:flex-row justify-between items-center p-10 bg-green text-white">
      <div class="m-auto">
        ...
        <div class="pt-2 flex justify-center gap-x-3">
          <a href="" class="inline-flex transition duration-200 ease-in hover:box-shadow hover:opacity-80">
            <img src="https://www.logo.wine/a/logo/App_Store_(iOS)/App_Store_(iOS)-Badge-Logo.wine.svg" alt="App Store"
              class="w-36" />
          </a>

          <a href="" class="inline-flex transition duration-200 ease-in hover:box-shadow hover:opacity-80">
            <img src="https://www.logo.wine/a/logo/Google_Play/Google_Play-Badge-Logo.wine.svg" alt="App Store"
              class="w-36" />
          </a>
        </div>
      </div>
      ...
      <div class="w-full md:w-6/12">
        <form class="w-full" noValidate>
          <div class="flex flex-col items-center">
            <div class="w-full">
              <input id="subscription_email" name="subscription_email" type="email" placeholder="Write your email here"
